...
using WebBanThietBiAmThanh.Areas.Admin.Models;
...
namespace WebBanThietBiAmThanh.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(db_maketContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            lsTrangThai.Add(new SelectListItem() { Text = "Bị Khóa", Value = "0" });
            ViewData["lsTrangThai"] = lsTrangThai;

            var db_maketContext = _context.Accounts.Include(a => a.Role);
            return View(await db_maketContext.ToListAsync());
        }
