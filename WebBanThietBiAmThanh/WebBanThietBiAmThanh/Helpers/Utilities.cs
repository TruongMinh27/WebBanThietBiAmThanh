...
namespace WebBanThietBiAmThanh.Helpers
{
    public class Utilities
    {
        ...
        public static string GetRandomKey(int lenth = 5)
        {
            //chuoi mau
        ...
        public static async Task<string> UploadFile(Microsoft.AspNetCore.Http.IFormFile file, string sDirectory ,string newname)
        {
            try
            {
                ...
                if(!supportedTypes.Contains(fileExt.ToLower()))//Khac cac file da dinh nghia
